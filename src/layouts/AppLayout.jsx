...
export default function AppLayout() {
  ...
  return (
    <div className="app-mobile-safe-shell min-h-screen bg-background">
      <aside className="app-layout-sidebar fixed inset-y-0 left-0 z-50 hidden border-r border-border bg-card md:bottom-0 md:top-[env(safe-area-inset-top,0px)] md:flex lg:top-0">
        <Sidebar />
      </aside>
