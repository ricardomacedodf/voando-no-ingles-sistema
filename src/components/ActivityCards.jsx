        ...
        {activities.map((item) => {
          ...
          return (
            <Link key={item.path} to={item.path} className="group block touch-manipulation">
              <div className="flex h-full flex-col rounded-xl border border-border bg-card p-6 shadow-sm transition-colors duration-200 md:transition-all md:hover:border-[#20D89A] md:hover:shadow-md">
                <div
                ...
                <div className="mt-auto flex items-center gap-1 text-sm font-medium text-[#20D89A] transition-[gap] duration-200 md:group-hover:gap-2">
                  <span>Começar</span>
